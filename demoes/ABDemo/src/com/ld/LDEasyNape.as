...
package com.ld
{
	...
	public class LDEasyNape
	{
		...
		private static var napeDebug:BitmapDebug;
		 ...
		 *
		 */		
		public static function createDebug():BitmapDebug{
			napeDebug= new BitmapDebug(550, 400, 0xD6D6D6);
		 ...
		 *
		 */		
		public static function createBox(posX:Number, posY:Number, width:Number, height:Number, isStatic:Boolean=false, isFixed:Boolean = false, userData:LDEasyUserData=null):Body{
			var body:Body;
		 ...
		 */		
		//创建指定边数的规则多边形刚体
		public static function createRegular( posX:Number, posY:Number, r:Number, edgeCount:int,rotation:Number, isStatic:Boolean=false, isFixed:Boolean=true, userData:LDEasyUserData=null):Body{
			var regular:Body;
		 ...
		 *
		 */		
		public static function createCircle(posX:Number, posY:Number, radius:int, isStatic:Boolean=false, isFixed:Boolean=false, userData:LDEasyUserData=null):Body
		{
			var circle:Body;
		 ...
		 *
		 */		
		private static function setUserData(body:Body,userData:LDEasyUserData):void
		{
			if(userData!=null){
				userData.body=body;
				userData.createGraphic();
				body.userData.graphic=userData.graphic;
