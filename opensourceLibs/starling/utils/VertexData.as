	...
	public class VertexData
	{
		...
		public function toString():String
		{
			...
			for (var i:int=0; i < numVertices; ++i)
			{
				...
				result+="  [Vertex " + i + ": " + "x=" + position.x.toFixed(1) + ", " + "y=" + position.y.toFixed(1) + ", " + "rgb=" + getColor(i).toString(16) + ", " + "a=" + getAlpha(i).toFixed(2) + ", " + "u=" + texCoords.x.toFixed(4) + ", " + "v=" + texCoords.y.toFixed(4) + "]" + (i == numVertices - 1 ? "\n" : ",\n");
			}
