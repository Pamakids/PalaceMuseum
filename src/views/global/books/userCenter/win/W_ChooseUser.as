package views.global.books.userCenter.win
{
	...
	public class W_ChooseUser extends FeathersControl
	{
		...
		{
			selectedTitle = BooksManager.getImage("background_selected_icon");
		...
		{
			var textureU:Texture = BooksManager.getTexture("button_editUser_up");
			var textureD:Texture = BooksManager.getTexture("button_editUser_down");
