package views.module5.scene52
{
	...
	public class OperaGame2 extends PalaceGame
	{
		...
		public function OperaGame2(lvl:int, am:AssetManager=null)
		{
			super(am);
			gameLevel=lvl;
		...
		private function addOneBody(index:int):void
		{
			...
			var bodyImg:Image=getImage(crtOperaName + "body" + type);
			var headImg:Image=getImage(crtOperaName + "head" + type);
